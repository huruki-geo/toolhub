...
const DEFAULT_CONFIG: PageConfig = {
  ...
  content: `
    <h1>Quikit.info - Smart Toolbox</h1>
    <p>Quikit.info is a collection of free, registration-free web tools. No app installation or login required. Just open your browser and start using them instantly.</p>
...
export const PAGES_EN: Record<string, PageConfig> = {
  ...
  "/tools/simple-timer": {
    title: "Simple Timer & Stopwatch | Quikit.info",
  ...
  "/tools/focus-timer": {
    title: "Focus & Cycle Timer (Pomodoro/HIIT) | Quikit.info",
  ...
  "/tools/log-timer": {
    title: "Log Timer (Time Tracking) | Quikit.info",
  ...
  "/tools/multi-timer": {
    title: "Multi Timer - Manage Multiple Timers | Quikit.info",
  ...
  "/tools/habitpal": {
    title: "Habit Pal - Simple Habit Tracker | Quikit.info",
  ...
  "/tools/browser-notepad": {
    title: "Browser Notepad - Auto-saving Editor | Quikit.info",
  ...
  "/tools/pixel-editor": {
    title: "Pixel Editor | Quikit.info",
  ...
  "/tools/tax-threshold-checker": {
    title: "Tax Threshold Checker (Japan) | Quikit.info",
  ...
  "/tools/schedule-formatter": {
    title: "Schedule Formatter | Quikit.info",
  ...
  "/tools/romaji-converter": {
    title: "Romaji Converter Pro | Quikit.info",
  ...
  "/tools/calorie-checker": {
    title: "Calorie & BMI Calculator | Quikit.info",
  ...
  "/tools/palettegen": {
    title: "Palette Generator | Quikit.info",
